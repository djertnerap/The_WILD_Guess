...
class FMoWDataset(WILDSDataset):
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official', seed=111, use_ood_val=True, region='all'):
        ...
        if region != 'all':
            self.metadata = self.metadata[self.metadata['region'] == region]
